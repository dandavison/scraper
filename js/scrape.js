...
(function() {
  var AtlanticWire, BBCUSandCanada, BBCUSandCanadaArticle, BingTrendingOnFacebook, Breitbart, BusinessInsider, BuzzFeed, CBS, CNNNewsPulse, CrooksAndLiars, DailyCaller, DailyKos, DailyMail, DrudgeReport, FoxNews, Gawker, Guardian, HuffingtonPost, LATimes, NPR, NYDailyNews, NewYorkTimes, PolicyMic, Politico, RealClearPolitics, Reason, Reddit, RedditAww, RedditWTF, Salon, Scraper, Slate, TheAtlantic, TheBlazeSocial, TheNation, TheWeek, ThinkProgress, ThinkProgressSocial, USAToday, Upworthy, WSJ, WSJWashwire, WashingtonExaminer, WashingtonPost, WashingtonPostOpinions, Wonkette, Yahoo, arg, cheerio, request, scraper_classes, scraper_classes_offbeat, scraper_classes_politix_all, scraper_classes_politix_social, scraper_cls, util, _CNN, _DailyBeast, _NewYorkTimesFrontPage, _PoliticalWire, _RollingStone, _i, _len,
  ...
  scraper_classes_politix_all = [TheAtlantic, BBCUSandCanadaArticle, BBCUSandCanada, BuzzFeed, DailyKos, DailyMail, DrudgeReport, Guardian, HuffingtonPost, TheNation, NYDailyNews, NewYorkTimes, Politico, RealClearPolitics, Reddit, Slate, USAToday, WashingtonPost, WashingtonPostOpinions, WSJ, WSJWashwire, TheWeek];

  scraper_classes_politix_social = [BingTrendingOnFacebook, DailyKos, DrudgeReport, FoxNews, HuffingtonPost, NewYorkTimes, Politico, Reason, Reddit, Salon, Slate, TheAtlantic, TheBlazeSocial, Upworthy, USAToday, WashingtonPost, WashingtonPostOpinions, WSJ];

  scraper_classes_offbeat = [BingTrendingOnFacebook, Gawker, HuffingtonPost, RedditWTF, RedditAww, Upworthy];
