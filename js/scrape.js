...
(function() {
  var AtlanticWire, BBCUSandCanada, BBCUSandCanadaArticle, BusinessInsider, BuzzFeed, CBS, CNN, CNNNewsPulse, CrooksAndLiars, DailyBeast, DailyCaller, DailyMail, FoxNews, Gawker, HuffingtonPost, LATimes, NPR, NYDailyNews, NewYorkTimes, NewYorkTimesFrontPage, PoliticalWire, Politico, RealClearPolitics, Reddit, RollingStone, SCRAPER_CLASSES, Scraper, Slate, TheAtlantic, TheBlaze, TheNation, TheWeek, ThinkProgress, USAToday, WSJ, WSJWashwire, WashingtonExaminer, WashingtonPost, WashingtonPostOpinions, Wonkette, Yahoo, jsdom, request, scraper_cls, util, _i, _len,
    ...
    Scraper.prototype.scrape = function() {
      ...
      return request({
        ...
        return jsdom.env({
          ...
          if (error) {
            data[_this.name]['Error'] = _this.make_fake_entry('Error loading jquery');
            return callback();
          } else {
