...
(function() {
  var AtlanticWire, BBCUSandCanada, BBCUSandCanadaArticle, BusinessInsider, BuzzFeed, CBS, CNNNewsPulse, CrooksAndLiars, DailyCaller, DailyKos, DailyMail, DrudgeReport, FoxNews, Guardian, HuffingtonPost, LATimes, NPR, NYDailyNews, NewYorkTimes, Politico, RealClearPolitics, Reddit, SCRAPER_CLASSES, Scraper, Slate, TheAtlantic, TheBlaze, TheNation, TheWeek, ThinkProgress, USAToday, WSJ, WSJWashwire, WashingtonExaminer, WashingtonPost, WashingtonPostOpinions, Wonkette, Yahoo, cheerio, request, scraper_cls, util, _CNN, _DailyBeast, _Gawker, _NewYorkTimesFrontPage, _PoliticalWire, _RollingStone, _i, _len,
  ...
  SCRAPER_CLASSES = [TheAtlantic, AtlanticWire, BBCUSandCanadaArticle, BBCUSandCanada, TheBlaze, BusinessInsider, BuzzFeed, _CNN, CNNNewsPulse, CBS, _DailyBeast, DailyCaller, DailyKos, DailyMail, DrudgeReport, FoxNews, Guardian, HuffingtonPost, LATimes, TheNation, NYDailyNews, NewYorkTimes, NPR, _PoliticalWire, Politico, RealClearPolitics, Reddit, _RollingStone, Slate, USAToday, WashingtonExaminer, WashingtonPost, WashingtonPostOpinions, WSJ, WSJWashwire, TheWeek, Yahoo];
