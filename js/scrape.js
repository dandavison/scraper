...
(function() {
  var AtlanticWire, BBCUSandCanada, BBCUSandCanadaArticle, BusinessInsider, BuzzFeed, CBS, CNNNewsPulse, CrooksAndLiars, DailyCaller, DailyKos, DailyMail, FoxNews, HuffingtonPost, LATimes, NPR, NYDailyNews, NewYorkTimes, Politico, RealClearPolitics, Reddit, SCRAPER_CLASSES, Scraper, Slate, TheAtlantic, TheBlaze, TheNation, TheWeek, ThinkProgress, USAToday, WSJ, WSJWashwire, WashingtonExaminer, WashingtonPost, WashingtonPostOpinions, Wonkette, Yahoo, cheerio, request, scraper_cls, util, _CNN, _DailyBeast, _DrudgeReport, _Gawker, _NewYorkTimesFrontPage, _PoliticalWire, _RollingStone, _i, _len,
  ...
  _DrudgeReport = (function(_super) {

    __extends(_DrudgeReport, _super);

    function _DrudgeReport() {
      this.name = '_DrudgeReport';
      this.domain = 'http://www.drudgereport.com';
    }

    _DrudgeReport.prototype.get_anchors = function() {
      return {
        "Failed to get this working so far": []
      };
    };

    return _DrudgeReport;
  ...
  _Gawker = (function(_super) {

    __extends(_Gawker, _super);
    ...
    _Gawker.prototype.get_anchors = function() {
      return {
  ...
  Slate = (function(_super) {
    ...
    Slate.prototype.get_anchors = function() {
      return {
        'Most Read & Most Shared': this.$('.most_read_and_commented li a').filter(function() {
  ...
  SCRAPER_CLASSES = [TheAtlantic, AtlanticWire, BBCUSandCanadaArticle, BBCUSandCanada, TheBlaze, BusinessInsider, BuzzFeed, _CNN, CNNNewsPulse, CBS, _DailyBeast, DailyCaller, DailyKos, DailyMail, _DrudgeReport, FoxNews, _Gawker, HuffingtonPost, LATimes, TheNation, NYDailyNews, NewYorkTimes, _NewYorkTimesFrontPage, NPR, _PoliticalWire, Politico, RealClearPolitics, Reddit, _RollingStone, Slate, USAToday, WashingtonExaminer, WashingtonPost, WashingtonPostOpinions, WSJ, WSJWashwire, TheWeek, Yahoo];
